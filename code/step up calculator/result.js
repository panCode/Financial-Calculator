			...
			<View >
				<Animated.View style = {{transform:transform1}}>
					<View style = {{flexDirection:'row',justifyContent:'center'}}>
						<Text style = {styles.text}>At the end of the Step-up SIP tenure, you can</Text>					
				...
				<Animated.View style = {{transform:transform2}}>
					<View style = {{flexDirection:'row',justifyContent:'center'}}>
						<Text style = {styles.text}>expect your SIP amount will grow to Rs.</Text>					
						{/*<Animated.View style = {{opacity}}>
													<Text style = {styles.value}>{sip_amount}/-</Text>
												</Animated.View>*/}
						{/*<Text style = {styles.text}>years your SIP amount will grow to Rs. </Text>*/}
					</View>
				</Animated.View>
